            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-6 lg:grid-cols-[1.3fr_0.7fr]">
                ...
                <aside className="rounded-[20px] border border-[#91918c40] bg-linear-to-b from-[#f6f6f3] to-[#ffffff] p-4">
                  ...
                  <button
                    className="mt-5 w-full rounded-2xl bg-[#e60023] px-4 py-2.5 text-xs text-white transition hover:-translate-y-px hover:brightness-95 disabled:cursor-not-allowed disabled:opacity-60"
