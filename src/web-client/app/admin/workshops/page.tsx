        ...
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              <button
                className="rounded-2xl border border-[#91918c4d] bg-white px-3 py-1.5 text-xs font-semibold text-[#211922] transition hover:-translate-y-px hover:bg-[#f6f6f3]"
                onClick={resetForm}
                type="button"
              >
                New workshop
            ...
            <div className="flex flex-wrap items-end gap-3">
              ...
              <label className="grid gap-2 text-xs text-[#62625b]">
                ...
                <span className="relative">
                  <svg
                    aria-hidden="true"
                    className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-[#91918c]"
                    fill="none"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <input
                    className="w-full rounded-full border border-[#91918c] bg-white py-2 pl-10 pr-4 text-sm text-[#211922] outline-none transition focus:border-[#435ee5]"
